"""
Django settings for round_leaf_dev_111600 project.
...
ROOT_URLCONF = 'round_leaf_dev_111600.urls'
...
WSGI_APPLICATION = 'round_leaf_dev_111600.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_leaf_dev_111600 API",
    "DESCRIPTION": "API documentation for round_leaf_dev_111600 App",
    "VERSION": "v1",
}
